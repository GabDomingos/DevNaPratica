 ...
 * 
 */
public class RetornaAlunosImpl {
	...
	public RetornaAlunosImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(RetornaAlunosInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.RETORNA_ALUNOS, //
	...
	*/
	public RetornaAlunosOutput retornaAlunos(RetornaAlunosInput input, long timeout) {
		...
		RetornaAlunosOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), RetornaAlunosOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<RetornaAlunosOutput> retornaAlunosRequest(RetornaAlunosInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, RetornaAlunosOutput.class);
	}
