...
public class ExportAvaliacaoOutput {
    
    public String exportJobId;
    
    public ExportAvaliacaoOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportAvaliacaoOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportAvaliacaoOutput)) {
            return false;
        }
        ExportAvaliacaoOutput other = (ExportAvaliacaoOutput) obj;
