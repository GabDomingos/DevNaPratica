 ...
 * 
 */
public class CreateAvaliacaoImpl {
	...
	public CreateAvaliacaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Avaliacao input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				BasicoConstants.Commands.CREATE_AVALIACAO, //
