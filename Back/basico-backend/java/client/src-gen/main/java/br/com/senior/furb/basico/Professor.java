...
public class Professor {
    ...
    public static class PagedResults {
        ...
        public List<Professor> contents;
        
        public PagedResults() {
        }
        
        public PagedResults(List<Professor> contents) {
            this.contents = contents;
        }
        
        public PagedResults(List<Professor> contents, Long totalPages, Long totalElements) {
            this.contents = contents;
     ...
     * Lista de turmas
     */
    public java.util.List<Turma> turmas;
     ...
     */
    public Professor(String id, String nome, java.time.LocalDate dataNascimento, java.time.LocalDate dataContratacao, Double salario, java.util.List<Turma> turmas) {
        this.id = id;
        this.nome = nome;
     ...
     */
    public Professor(String nome, java.time.LocalDate dataNascimento, java.time.LocalDate dataContratacao, Double salario, java.util.List<Turma> turmas) {
        this.nome = nome;
        this.dataNascimento = dataNascimento;
        this.dataContratacao = dataContratacao;
        this.salario = salario;
    ...
    void toString(StringBuilder sb, List<Object> appended) {
    	...
    	if (turmas == null) {
    		...
    		sb.append('[');
    		int last = turmas.size() - 1;
    		for (int i = 0; i <= last; i++) {
    			turmas.get(i).toString(sb, appended);
    			if (i < last) {
    				sb.append(", ");
    			}
    		}
