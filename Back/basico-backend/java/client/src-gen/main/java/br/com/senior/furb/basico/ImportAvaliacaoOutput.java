...
public class ImportAvaliacaoOutput {
    
    public String importJobId;
    
    public ImportAvaliacaoOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportAvaliacaoOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportAvaliacaoOutput)) {
            return false;
        }
        ImportAvaliacaoOutput other = (ImportAvaliacaoOutput) obj;
