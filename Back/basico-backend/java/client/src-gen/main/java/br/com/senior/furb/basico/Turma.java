...
public class Turma {
     ...
     * Horário
     */
    public java.time.LocalTime horario;
    /**
     ...
     */
    public Turma(String id, String descTurma, java.time.LocalTime horario, Double valorMensalidade, Long limiteAlunos, java.util.List<Aluno> alunos) {
        this.id = id;
     ...
     */
    public Turma(String descTurma, java.time.LocalTime horario, Double valorMensalidade, Long limiteAlunos, java.util.List<Aluno> alunos) {
        this.descTurma = descTurma;
        this.horario = horario;
        this.valorMensalidade = valorMensalidade;
        this.limiteAlunos = limiteAlunos;
