 ...
 * 
 */
public class RetornaProfessoresImpl {
	...
	public RetornaProfessoresImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(RetornaProfessoresInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.RETORNA_PROFESSORES, //
	...
	*/
	public RetornaProfessoresOutput retornaProfessores(RetornaProfessoresInput input, long timeout) {
		...
		RetornaProfessoresOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), RetornaProfessoresOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<RetornaProfessoresOutput> retornaProfessoresRequest(RetornaProfessoresInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, RetornaProfessoresOutput.class);
	}
