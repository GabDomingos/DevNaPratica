 ...
 * 
 */
public class GravaProfessorImpl {
	...
	public GravaProfessorImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(GravaProfessorInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.GRAVA_PROFESSOR, //
	...
	*/
	public GravaProfessorOutput gravaProfessor(GravaProfessorInput input, long timeout) {
		...
		GravaProfessorOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), GravaProfessorOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<GravaProfessorOutput> gravaProfessorRequest(GravaProfessorInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, GravaProfessorOutput.class);
	}
