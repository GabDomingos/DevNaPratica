 ...
 * 
 */
public class CreateBulkAvaliacaoImpl {
	...
	public CreateBulkAvaliacaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkAvaliacaoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_AVALIACAO, //
	...
	*/
	public CreateBulkAvaliacaoOutput createBulkAvaliacao(CreateBulkAvaliacaoInput input, long timeout) {
		...
		CreateBulkAvaliacaoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkAvaliacaoOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkAvaliacaoOutput> createBulkAvaliacaoRequest(CreateBulkAvaliacaoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkAvaliacaoOutput.class);
	}
