 ...
 * 
 */
public class ImportAvaliacaoImpl {
	...
	public ImportAvaliacaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ImportAvaliacaoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.IMPORT_AVALIACAO, //
	...
	*/
	public ImportAvaliacaoOutput importAvaliacao(ImportAvaliacaoInput input, long timeout) {
		...
		ImportAvaliacaoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ImportAvaliacaoOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ImportAvaliacaoOutput> importAvaliacaoRequest(ImportAvaliacaoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ImportAvaliacaoOutput.class);
	}
