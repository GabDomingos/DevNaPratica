 ...
 * 
 */
public class ListAvaliacaoImpl {
	...
	public ListAvaliacaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(Avaliacao.PageRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.LIST_AVALIACAO, //
	...
	*/
	public Avaliacao.PagedResults listAvaliacao(Avaliacao.PageRequest input, long timeout) {
		...
		Avaliacao.PagedResults output = DtoJsonConverter.toDTO(resultMessage.getContent(), Avaliacao.PagedResults.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<Avaliacao.PagedResults> listAvaliacaoRequest(Avaliacao.PageRequest input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, Avaliacao.PagedResults.class);
	}
