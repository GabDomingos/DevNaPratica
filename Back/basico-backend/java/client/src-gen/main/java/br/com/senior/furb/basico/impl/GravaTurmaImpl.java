...
public class GravaTurmaImpl {
	...
	public GravaTurmaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(GravaTurmaInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.GRAVA_TURMA, //
	...
	*/
	public GravaTurmaOutput gravaTurma(GravaTurmaInput input, long timeout) {
		...
		GravaTurmaOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), GravaTurmaOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<GravaTurmaOutput> gravaTurmaRequest(GravaTurmaInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, GravaTurmaOutput.class);
	}
